...
function (_Component) {
  ...
  _createClass(DuaWrapper, [{
    ...
    value: function render() {
      var duas = this.state.duas; // const novo = duas.map((item,index)=>{
      //     return (
      ...
      })), state.results && this.state.results.map(function (result) {
...
//# sourceMappingURL=4.2253e560cfa011f5f6d5.hot-update.js.map