...
function (_Component) {
  ...
  _createClass(DuaWrapper, [{
    ...
    value: function render() {
      ...
      }, "           This     ", __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("hr", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 77
        }
...
function (_Component2) {
  ...
  _createClass(InputField, [{
    ...
    value: function render() {
      ...
      }), this.state.results && this.state.results.map(function (result, index) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Duas, {
          key: index,
          title: result.title,
          content: result.body,
...
//# sourceMappingURL=4.7e168923c44de5c3b4fe.hot-update.js.map