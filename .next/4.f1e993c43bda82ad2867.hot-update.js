...
function (_Component2) {
  ...
  _createClass(InputField, [{
    ...
    value: function render() {
      ...
      }), this.state.results && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Duas, {
        title: this.state.results[0].title,
        content: this.state.results[0].body,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 111
        }
...
//# sourceMappingURL=4.f1e993c43bda82ad2867.hot-update.js.map